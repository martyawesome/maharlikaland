...
Route::bind('bill_electricity', function ($date_covered, $route) {
	$project = $route->parameter('project');
	$bill_electricity = App\BillElectricitySource::whereProjectId($project->id)
		->whereDateCovered($date_covered)
        ->first();

    if($bill_electricity == null) {
    	$bill_electricity = new App\BillElectricitySource();
    }

    return $bill_electricity;
});

Route::bind('bill_electricity_detail', function ($date_covered, $route) {
	$property = $route->parameter('property');
	$bill_electricity_detail = App\BillElectricitySourceDetail::wherePropertyId($property->id)
	->whereDateCovered($date_covered)->first();

    if($bill_electricity_detail == null) {
    	$bill_electricity_detail = new App\BillWaterSourceDetail();
    }

    return $bill_electricity_detail;
});
...
Route::group(['namespace' => 'Developers'], function()  {
		...
		Route::group(['before' => 'auth_developer'], function ()  {
			...
			Route::get('/bills/electricity', ['as' => 'bills_electricity_projects','uses' => 'BillsElectricitySourceController@showProjects']);
			Route::get('/bills/electricity/{project}', ['as' => 'bills_electricity_project','uses' => 'BillsElectricitySourceController@showProjectBills']);
			Route::get('/bills/electricity/{project}/add', ['as' => 'add_bill_electricity_project','uses' => 'BillsElectricitySourceController@showAddProjectBill']);
			Route::get('/bills/electricity/{project}/{bill_electricity?}', ['as' => 'view_bill_electricity_project','uses' => 'BillsElectricitySourceController@showProjectBill']);
			Route::get('/bills/electricity/{project}/{bill_electricity?}/edit', ['as' => 'edit_bill_electricity_project','uses' => 'BillsElectricitySourceController@showEditProjectBill']);
			
			// Electricity Bill - Project Export
			Route::get('/bills/electricity/{project}/export/excel', ['as' => 'export_project_electricity_bills_to_excel','uses' => 'BillsElectricitySourceController@exportProjectBillsToExcel']);
			Route::get('/bills/electricity/{project}/export/pdf', ['as' => 'export_project_electricity_bills_to_pdf','uses' => 'BillsElectricitySourceController@exportProjectBillsToPdf']);
			// Electricity Bill - Property
			Route::get('/bills/electricity/{project}/{property}/{bill_electricity_detail?}/edit', ['as' => 'edit_bill_electricity_monthly','uses' => 'BillsElectricitySourceController@showEditPropertyBill']);
			// Electricity Bill - Property Export
			Route::get('/bills/electricity/{project}/{bill_electricity?}/export/excel', ['as' => 'export_monthly_electricity_bills_to_excel','uses' => 'BillsElectricitySourceController@exportMonthlyBillsToExcel']);	
			Route::get('/bills/electricity/{project}/{bill_electricity?}/export/pdf', ['as' => 'export_monthly_electricity_bills_to_pdf','uses' => 'BillsElectricitySourceController@exportMonthlyBillsToPdf']);		

			// Electricity Bill - Project
			Route::post('/bills/electricity/{project}/add','BillsElectricitySourceController@addProjectBill');
			Route::post('/bills/electricity/{project}/{bill_electricity?}/edit','BillsElectricitySourceController@editProjectBill');
			Route::post('/bills/electricity/{project}', 'BillsElectricitySourceController@importProjectBillsFromExcel');
			// Electricity Bill - Property
			Route::post('/bills/electricity/{project}/{property}/{bill_electricity_detail?}/edit','BillsElectricitySourceController@editPropertyBill');
			Route::post('/bills/electricity/{project}/{bill_electricity?}','BillsElectricitySourceController@importMonthlyBillsFromExcel');
			Route::post('/bills/electricity/{project}/{bill_electricity?}/delete', 'BillsElectricitySourceController@deleteProjectBill');
