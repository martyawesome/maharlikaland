...
<html>
  <head>
    ...
    {!! HTML::style('bower_components/admin-lte/dist/css/skins/skin-green.css') !!}
  ...
  <body class="hold-transition">
    ...
    <div class="login-box">
      <div class="login-logo">
        <b>Maharlika</b><b class="login-logo-secondary">Land</b><br/>
      </div>
      <p class="login-logo-small ">Properties and Homes Corp</p>
