...
@section('content')
  ...
  <section class="content">
    <div class="box box-primary">
      <div class="box-body">
        <a href="{{ route('add_cash_advance_payment') }}" class="btn btn-success" style="margin-right: 5px;">Add</a>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
              ...
              <table id="objects" class="table table-bordered table-striped">
                ...
                <tbody>
                  @foreach($cash_advances as $cash_advance)
                    <tr class='clickable-row' style="cursor: pointer;" data-href="{{ URL::route('edit_cash_advance_payment', array($cash_advance->id)) }}">
                      <td>
            ...
            @else
              No cash advances payments found
            @endif
          </div>
        </div>
      </div>
