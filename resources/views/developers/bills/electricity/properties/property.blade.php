  ...
  <section class="content">
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Electricity Bills</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
    ...
    <div style="margin-bottom:15px;">
      @if(Auth::user()->user_type_id == config('constants.USER_TYPE_DEVELOPER_ADMIN') 
        ...
        {!! link_to_route('add_bill_electricity_property', 'Add', array($project->slug,$property->slug), ['class' => 'btn btn-primary', 'style' => 'margin-right:5px;']) !!}
