...
<head>
  ...
  <link rel="icon" href="{{ URL::to('/') }}/resapp-logo.png" type="image/gif" sizes="16x16">
...
<body class="hold-transition skin-purple-light sidebar-mini">
  <div class="wrapper">
    <header class="main-header">
      <a href="{{ URL::route('agent_dashboard') }}" class="logo">
        <span class="logo-mini"><b>Resapp</b></span>
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-right">
                    <a href="{{ URL::route('agent_logout') }}" class="btn btn-default btn-flat">Sign out</a>
                  </div>
                </li>
              </ul>
            </li>
    ...
    <aside class="main-sidebar">
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          <li class="header"></li>
          <li>
              <a href="{{ URL::route('agent_dashboard') }}"><i class="fa fa-television"></i> <span>Dashboard</span></a>
          </li>
          <li class="treeview">
            <a href="#"><i class="fa fa-building-o"></i> <span>Properties</span> <i class="fa fa-angle-left pull-right"></i></a>
            <ul class="treeview-menu">
              <li><a href="{{ URL::route('agent_create_property') }}"><i class="fa fa-plus"></i>Add Property</a></li>
              <li><a href="{{ URL::route('agent_all_properties') }}"><i class="fa fa-list-ol"></i>All Properties</a></li>
            </ul>
          </li>
          <li class="treeview">
            <a href="{{ URL::route('agent_about_me') }}"><i class="fa fa-smile-o"></i> <span>About Me</span></a>
          </li>
          <!-- <li class="treeview">
              <a href="#"><i class="fa fa-bar-chart-o"></i> <span>Reports</span></a>
          </li> -->
          <li class="treeview">
            <a href="{{ URL::route('agent_my_account', Auth::user()->id) }}"><i class="fa fa-user"></i> <span>My Account</span></a>
          </li>
        </ul>
      </section>
    </aside>
